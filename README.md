# Nestora Agent — Agentic AI Hackathon Edition

> An autonomous property-rental decision agent built on the existing Nestora platform. It plans, uses tools, adapts to unavailable properties or changed preferences, and executes a verified shortlist action.

See **[AGENTIC_HACKATHON.md](./AGENTIC_HACKATHON.md)** for the architecture, demo flow, and run instructions.
